        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-600 mb-4">
              Empowering Indian farmers with technology for better yields and direct market access.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/crop-recommendation" className="text-gray-600 hover:text-primary-600">Crop Recommendations</Link></li>
              <li><Link to="/disease-detection" className="text-gray-600 hover:text-primary-600">Disease Detection</Link></li>
              <li><Link to="/marketplace" className="text-gray-600 hover:text-primary-600">Marketplace</Link></li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-600 hover:text-primary-600">Farming Tips</a></li>
              <li><a href="#" className="text-gray-600 hover:text-primary-600">Crop Calendar</a></li>
              <li><a href="#" className="text-gray-600 hover:text-primary-600">Weather Updates</a></li>
              <li><a href="#" className="text-gray-600 hover:text-primary-600">Government Schemes</a></li>
          ...
          <div className="col-span-1">
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                <MapPin size={20} className="text-primary-700 mt-1 mr-3" />
                <p className="text-gray-600">123 Agricultural Road, New Delhi, 110001, India</p>
              </div>
              <div className="flex items-center">
                <Phone size={20} className="text-primary-700 mr-3" />
                <p className="text-gray-600">+91 1234567890</p>
              </div>
              <div className="flex items-center">
                <Mail size={20} className="text-primary-700 mr-3" />
        ...
        <div className="border-t border-gray-200 mt-10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 text-sm">
              © 2025 KrishiMitra. All rights reserved.
            </p>
